      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <!-- /Logo -->
            <h4 class="mb-2">Selamat Datang di Perpustakaan Digital! 👋</h4>
            <p class="mb-4">Silahkan Login ke akun anda dan mulai pengalaman seru!</p>
            ...
            <div class="mb-3">
              <a class="btn btn-secondary d-grid w-100" href="guest">Masuk Sebagai Tamu</a>
            </div>
            <p class=" text-center">
