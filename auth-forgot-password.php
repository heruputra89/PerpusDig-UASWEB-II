...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="assets/sneat/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Mohon maaf atas ketidaknyamanannya, namun saat ini kami sedang melakukan pemeliharaan</p>
        <a href="index.php" class="btn btn-primary">Kembali ke Beranda</a>
        <div class="mt-4">
          <img
            src="assets/sneat/assets/img/illustrations/girl-doing-yoga-light.png"
    ...
    <script src="assets/sneatassets/vendor/libs/jquery/jquery.js"></script>
    <script src="assets/sneatassets/vendor/libs/popper/popper.js"></script>
    <script src="assets/sneatassets/vendor/js/bootstrap.js"></script>
    <script src="assets/sneatassets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>

    <script src="assets/sneatassets/vendor/js/menu.js"></script>
    <!-- endbuild -->

    <!-- Vendors JS -->

    <!-- Main JS -->
    <script src="assets/sneatassets/js/main.js"></script>
