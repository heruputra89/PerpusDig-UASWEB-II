              ...
              <div class="card h-100">
                <div class="card-body">
                  ...
                  <button
                    ...
                    data-bs-html="true"
                    data-bs-content="<p>Fitur ini hanya dapat digunakan oleh pengguna yang sudah terdaftar.</p> <div class='d-flex justify-content-between'><a href='../auth-register.php' class='btn btn-sm btn-outline-secondary'>Daftar</a><a href='../auth-login.php' class='btn btn-sm btn-primary'>Masuk</a></div>"
                    title="Batasan Tamu">
                    Baca Online
                  </button>
                  <button
                    ...
                    data-bs-placement="top"
                    data-bs-html="true"
                    data-bs-content="<p>Fitur ini hanya dapat digunakan oleh pengguna yang sudah terdaftar.</p> <div class='d-flex justify-content-between'><a href='../auth-register.php' class='btn btn-sm btn-outline-secondary'>Daftar</a><a href='../auth-login.php' class='btn btn-sm btn-primary'>Masuk</a>
                </div>"
                    title="Batasan Tamu">
                    UnduhPDF
                  </button>
