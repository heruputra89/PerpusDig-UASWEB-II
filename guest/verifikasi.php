...
if (isset($_GET['barcode']) && !empty($_GET['barcode'])) {
    ...
    if (!filter_var($barcode, FILTER_VALIDATE_INT)) {
        $error = "barcode tidak valid.";
    }

    // Persiapkan statement SQL
    $stmt = $conn->prepare("SELECT id, judul, penerbit, isbn, edisi, penulis, barcode FROM buku WHERE barcode = ?");
...
<body>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p id="error-message">Terjadi kesalahan. Buku tidak ditemukan.</p>
                            </div>
                ...
                <div class="modal fade" id="detailModal" data-bs-backdrop="static" tabindex="-1">
                    <div class="modal-dialog">
                        <form class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="backDropModalTitle">Terverifikasi | Buku Milik XII-1</h5>
                                <button
                                    type="button"
                                    class="btn-close"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <p><strong>Judul:</strong> <span id="modal-judul"><?php echo htmlspecialchars($book['judul']); ?></span></p>
                                    <p><strong>Penerbit:</strong> <span id="modal-penerbit"><?php echo htmlspecialchars($book['penerbit']); ?></span></p>
                                    <p><strong>ISBN:</strong> <span id="modal-isbn"><?php echo htmlspecialchars($book['isbn']); ?></span></p>
                                    <p><strong>Edisi:</strong> <span id="modal-edisi"><?php echo htmlspecialchars($book['edisi']); ?></span></p>
                                    <p><strong>Penulis:</strong> <span id="modal-penulis"><?php echo htmlspecialchars($book['penulis']); ?></span></p>
                                    <p><strong>Barcode:</strong> <span id="modal-barcode"><?php echo htmlspecialchars($book['barcode']); ?></span></p>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script>
        // Mengarahkan pengguna ke halaman tertentu setelah modal ditutup
        document.addEventListener('DOMContentLoaded', function() {
            var detailModal = document.getElementById('detailModal');
            var errorModal = document.getElementById('errorModal');

            detailModal.addEventListener('hidden.bs.modal', function() {
                window.location.href = '../index.php'; // Ubah URL sesuai kebutuhan
            });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if (isset($error)): ?>
                ...
                document.getElementById('error-message').textContent = <?php echo json_encode($error); ?>;
                errorModal.show();
