                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <h3 class="card-title mb-2"><?php echo number_format($totalbuku); ?></h3>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          <div class="avatar flex-shrink-0">
                            <img
                              src="../assets/sneat/assets/img/icons/unicons/chart.png"
                              alt="chart"
                              class="rounded" />
                          </div>
                        </div>
                        <span class="fw-semibold d-block mb-1">Pengguna</span>
                        <h3 class="card-title text-nowrap mb-1"><?php echo number_format($totaluser); ?></h3>
                      </div>
                    </div>
                  </div>
                </div>
