...
// Find out the number of results stored in the database based on the search term
$sql = "SELECT COUNT(*) AS total FROM daftarbuku WHERE judul LIKE ?";
...
// Fetch the relevant records for the current page based on the search term
$sql = "SELECT id, judul, penerbit, isbn, edisi, penulis, link_cover, link_buku FROM daftarbuku WHERE judul LIKE ? LIMIT ?, ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sii", $search_term_wildcard, $start_from, $results_per_page);
$stmt->execute();
$result = $stmt->get_result();
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="card">
                <h5 class="card-header">Daftar E-Book</h5>
                <div class="card-body">
                  <!-- Search Form -->
                  <form method="get" action="">
                    <div class="input-group mb-3">
                      <input type="text" class="form-control" name="search" value="<?php echo htmlspecialchars($search_term); ?>" placeholder="Cari judul buku...">
                  ...
                  <button
                    ...
                    data-bs-target="#insertBookModal">
                    Tambah E-Book
                  </button>
                </div>
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      while ($row = $result->fetch_assoc()): ?>
                        <tr>
                          <td><?php echo  $no; ?></td>
                          <td>
                            <img src="<?php echo htmlspecialchars($row['link_cover']); ?>" alt="Cover" class="cover-img" style="width: 70px; height: auto; cursor: pointer;">
                          </td>
                          <td><?php echo htmlspecialchars($row['judul']); ?></td>
                          <td>
                            <a href="detailbuku.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-primary" role="button">
                              Lihat Detail
                            </a>
                            <form action="delete_ebook.php" method="post" style="display:inline;">
              ...
              <ul class="pagination justify-content-center">
                ...
                <?php for ($page = 1; $page <= $total_pages; $page++): ?>
                  <li class="page-item <?php if ($page == $current_page) echo 'active'; ?>">
                    <a class="page-link" href="?page=<?php echo $page; ?>&search=<?php echo urlencode($search_term); ?>"><?php echo $page; ?></a>
                  </li>
                <?php endfor; ?>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="coverModalLabel">Gambar Sampul</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <img id="modal-cover-img" src="" alt="Cover" class="img-fluid">
                  </div>
            ...
            <div class="modal fade" id="insertBookModal" tabindex="-1" aria-labelledby="insertBookModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="insertBookModalLabel">Tambah E-Book</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <form action="insert_ebook.php" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="link_cover" name="link_cover" required>
                      </div>
                      <div class="mb-3">
                        <label for="link_buku" class="form-label">Link Buku</label>
                        <input type="text" class="form-control" id="link_buku" name="link_buku" required>
                      </div>
                      <div class="mb-3">
                        <label for="link_unduh" class="form-label">Link Unduh</label>
                        <input type="text" class="form-control" id="link_unduh" name="link_unduh" required>
                      </div>
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
