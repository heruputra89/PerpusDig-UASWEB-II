...
$sql = "SELECT COUNT(*) AS total FROM buku WHERE judul LIKE ?";
...
$sql = "SELECT id, judul, penerbit, isbn, edisi, penulis, barcode FROM buku WHERE judul LIKE ? LIMIT ?, ?";
$stmt = $conn->prepare($sql);
...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            while ($row = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo htmlspecialchars($row['edisi']); ?>
                                                    </td>
                                                    <td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="qrCodeModalLabel">QR Code for Verification</h5>
                        ...
                        <div class="modal fade" id="insertBookModal" tabindex="-1" aria-labelledby="insertBookModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="insertBookModalLabel">Tambah Buku</h5>
    ...
    <script>
        $('#qrCodeModal').on('show.bs.modal', function(event) {
            ...
            var barcode = button.data('barcode'); // Extract info from data-* attributes

            var url = 'http://localhost/perpustakaan/guest/verifikasi.php?barcode=' + encodeURIComponent(barcode);
