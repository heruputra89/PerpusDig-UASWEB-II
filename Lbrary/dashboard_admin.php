...
<head>
    ...
    <title>Dashboard Admin - Lbrary</title>
    <!-- Modern Fonts -->
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="welcome-section" data-aos="fade-up">
            ...
            <p class="mb-0">Anda login sebagai Administrator</p>
            <div class="py-2"></div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                <div class="stats-card">
                    <i class="ri-user-fill stats-icon"></i>
                    <h3 class="stats-number"><?= $total_users ?></h3>
                    <p class="stats-label">Total Pengguna</p>
                    <div class="mt-2">
                        <span class="badge bg-success"><?= $active_users ?> Aktif</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                <div class="stats-card">
                    <i class="ri-stack-fill stats-icon"></i>
                    <h3 class="stats-number"><?= $available_books ?></h3>
                    <p class="stats-label">Total Buku Tersedia</p>
                </div>
            </div>
        </div>
         ...
         <div class="row g-4 mb-4">
            <div class="col-12" id="pengguna-section" data-aos="fade-up">
                <div class="table-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="tambahakun.php" class="btn btn-primary btn-custom">
                            <i class="ri-add-circle-line me-1"></i></i>Tambah Akun
                            </a>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($data_akun as $akun): ?>
                                        <tr>
                                            <td><?= htmlspecialchars($akun['name']) ?></td>
                                            <td><?= htmlspecialchars($akun['username']) ?></td>
                                            <td><?= htmlspecialchars($akun['password']) ?></td>
                                            <td><?= htmlspecialchars($akun['email']) ?></td>
                                            <td><?= htmlspecialchars($akun['no_telp']) ?></td>
                                            <td>
                                                <span class="badge bg-secondary"><?= ucfirst($akun['level']) ?></span>
                                            </td>
                                            <td>
                                                <span class="badge <?= $akun['status'] === 'aktif' ? 'bg-success' : 'bg-danger' ?>">
                                                    <?= ucfirst($akun['status']) ?>
                                                </span>
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="ubahakun.php?id=<?= $akun['id_user'] ?>" class="btn btn-sm btn-outline-primary">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <a href="hapusakun.php?id=<?= $akun['id_user'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Yakin ingin menghapus akun ini?')">
