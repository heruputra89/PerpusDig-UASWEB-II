...
// Get statistics
$total_books = select("SELECT COUNT(*) as total FROM buku")[0]['total'];
$total_categories = select("SELECT COUNT(*) as total FROM kategori")[0]['total'];

// Get book statistics
$total_stock = select("SELECT SUM(status) as total FROM buku")[0]['total'];
$available_books = select("SELECT COUNT(*) as total FROM buku WHERE status > 0")[0]['total'];

// Get all books with category and shelf information
...
<head>
    ...
    <title>Dashboard User - Lbrary</title>
    <!-- Modern Fonts -->
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="#peminjaman-section" class="sidebar-link">
    ...
    <div class="main-content">
        ...
        <div class="welcome-section" data-aos="fade-up">
            ...
            <p class="mb-0">Anda login sebagai Petugas Perpustakaan</p>
            <div class="py-2"></div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                <div class="stats-card">
                    ...
                    <h3 class="stats-number"><?= $total_stock ?></h3>
                    <p class="stats-label">Total Buku Aktif</p>
                </div>
            </div>
        </div>
                ...
                <div class="table-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <i class="ri-add-circle-line me-1"></i>Tambah Buku
                            </a>
                        </div>
        ...
        <div class="row g-4" id="kategori-section">
            <div class="col-12" data-aos="fade-up" data-aos-delay="100">
                <div class="table-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">
                                <i class="ri-folder-line me-2"></i>Kategori Buku
                            </h4>
                                    ...
                                    <?php if (count($data_kategori) === 0): ?>
                                        <tr>
                                            <td colspan="3" class="text-center text-muted">
                                                <i class="ri-folder-line me-2"></i>Tidak ada kategori yang tersedia
                                            </td>
                                        </tr>
                                    <?php else: ?>
