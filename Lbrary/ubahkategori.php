...
// Mengambil id data kategori
if (isset($_GET['id'])) {
    $id = (int)$_GET['id'];
    $kategori = select("SELECT * FROM kategori WHERE id_kategori=$id")[0];
    ...
    if (isset($_POST['ubah'])) {
        if (ubah_kategori($_POST) > 0) {
            $showAlert = true;
            $alertType = 'success';
            $alertMessage = 'Data kategori berhasil diubah!';
        } else {
            $showAlert = true;
            $alertType = 'error';
            $alertMessage = 'Gagal mengubah data kategori!';
        }
    }
} else {
    header("Location: " . getDashboardUrl());
...
<head>
    ...
    <title>Ubah Kategori | E-Perpustakaan</title>
    <!-- Modern Fonts -->
    ...
    <div class="form-container">
        ...
        <div class="form-card">
            <div class="form-header">
                <h1 class="form-title">
                    <i class="ri-price-tag-3-line mr-2"></i>Ubah Kategori
                </h1>
                <p class="form-subtitle">Perbarui informasi kategori dengan data terbaru</p>
            </div>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" class="form-control w-full" id="nama_kategori" name="nama_kategori" value="<?= htmlspecialchars($kategori['nama_kategori']) ?>" required>
                </div>
