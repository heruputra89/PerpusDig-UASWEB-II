...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $sql = "INSERT INTO users (nama, email, password_hash) VALUES (?, ?, ?)";
  ...
  if ($stmt->execute()) {
    ...
    // Assuming the role is set or retrieved from somewhere
    $role = 'user'; // Set the role as 'user' or retrieve from database if needed
      ...
      <div class="authentication-inner">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-4">Buat petualangan seru dengan PusDig!</p>
            <?php
              ...
              <div class="mb-3">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="terms-conditions">
                    Saya Setuju
                    <a href="javascript:void(0);">ketentuan & kebijakan privasi</a>
                  </label>
                </div>
              </div>
  ...
  <script>
    document.getElementById('formAccountSettings').addEventListener('submit', function(event) {
      ...
      if (!termsCheckbox.checked) {
        alert('Anda harus menyetujui ketentuan & kebijakan privasi sebelum melanjutkan.');
